...
const TAG_DISPOSITIONS: Dictionary = {
	"PMDC.Dungeon.KnockBackEvent, PMDC": {"disposition": "planned_forced_movement", "step": "3.1", "gate": ""},
	"PMDC.Dungeon.ThrowBackEvent, PMDC": {"disposition": "planned_forced_movement", "step": "3.1", "gate": ""},
	"PMDC.Dungeon.SwitcherEvent, PMDC": {"disposition": "planned_forced_movement", "step": "3.1", "gate": ""},
	"PMDC.Dungeon.HopEvent, PMDC": {"disposition": "planned_forced_movement", "step": "3.1", "gate": ""},
	"PMDC.Dungeon.WarpAlliesInEvent, PMDC": {"disposition": "planned_forced_movement", "step": "3.1", "gate": ""},
	"PMDC.Dungeon.RandomWarpEvent, PMDC": {"disposition": "planned_forced_movement", "step": "3.1", "gate": ""},
	"PMDC.Dungeon.OHKODamageEvent, PMDC": {"disposition": "planned_damage_variant", "step": "3.2", "gate": ""},
	"PMDC.Dungeon.CutHPDamageEvent, PMDC": {"disposition": "planned_damage_variant", "step": "3.2", "gate": ""},
	"PMDC.Dungeon.MaxHPDamageEvent, PMDC": {"disposition": "planned_damage_variant", "step": "3.2", "gate": ""},
	"PMDC.Dungeon.EndeavorEvent, PMDC": {"disposition": "planned_damage_variant", "step": "3.2", "gate": ""},
	"PMDC.Dungeon.PsywaveDamageEvent, PMDC": {"disposition": "planned_damage_variant", "step": "3.2", "gate": ""},
	"PMDC.Dungeon.BasePowerDamageEvent, PMDC": {"disposition": "planned_damage_variant", "step": "3.2", "gate": ""},
	"PMDC.Dungeon.PainSplitEvent, PMDC": {"disposition": "planned_stat_hp_manipulation", "step": "3.3", "gate": ""},
	"PMDC.Dungeon.StatSplitEvent, PMDC": {"disposition": "planned_stat_hp_manipulation", "step": "3.3", "gate": ""},
	"PMDC.Dungeon.SwapStatsEvent, PMDC": {"disposition": "planned_stat_hp_manipulation", "step": "3.3", "gate": ""},
	"PMDC.Dungeon.PowerTrickEvent, PMDC": {"disposition": "planned_stat_hp_manipulation", "step": "3.3", "gate": ""},
	"PMDC.Dungeon.ReflectStatsEvent, PMDC": {"disposition": "planned_stat_hp_manipulation", "step": "3.3", "gate": ""},
	"PMDC.Dungeon.RestEvent, PMDC": {"disposition": "planned_heal_sleep", "step": "4.1", "gate": ""},
	"PMDC.Dungeon.MirrorMoveEvent, PMDC": {"disposition": "planned_move_copying", "step": "6.1", "gate": ""},
	"PMDC.Dungeon.RandomMoveEvent, PMDC": {"disposition": "planned_move_copying", "step": "6.1", "gate": ""},
	"PMDC.Dungeon.MimicBattleEvent, PMDC": {"disposition": "planned_move_copying", "step": "6.1", "gate": ""},
	"PMDC.Dungeon.SketchBattleEvent, PMDC": {"disposition": "planned_move_copying", "step": "6.1", "gate": ""},
	"PMDC.Dungeon.NatureMoveEvent, PMDC": {"disposition": "planned_move_copying", "step": "6.1", "gate": ""},
	"PMDC.Dungeon.CopycatEvent, PMDC": {"disposition": "planned_move_copying", "step": "6.1", "gate": ""},
	"PMDC.Dungeon.SwapAbilityEvent, PMDC": {"disposition": "planned_ability_dependent", "step": "6.2", "gate": ""},
	"PMDC.Dungeon.ReflectAbilityEvent, PMDC": {"disposition": "planned_ability_dependent", "step": "6.2", "gate": ""},
	"PMDC.Dungeon.ChangeToAbilityEvent, PMDC": {"disposition": "planned_ability_dependent", "step": "6.2", "gate": ""},
	"PMDC.Dungeon.TransferStatusEvent, PMDC": {"disposition": "planned_status_dependent", "step": "6.3", "gate": ""},
	"PMDC.Dungeon.StatusStateBattleEvent, PMDC": {"disposition": "planned_status_dependent", "step": "6.3", "gate": ""},
	"PMDC.Dungeon.SetItemStickyEvent, PMDC": {"disposition": "planned_status_dependent", "step": "6.3", "gate": ""},
	"PMDC.Dungeon.BegItemEvent, PMDC": {"disposition": "planned_item_dependent", "step": "7.4", "gate": ""},
	"PMDC.Dungeon.BestowItemEvent, PMDC": {"disposition": "planned_item_dependent", "step": "7.4", "gate": ""},
	"PMDC.Dungeon.LandItemEvent, PMDC": {"disposition": "planned_item_dependent", "step": "7.4", "gate": ""},
	"PMDC.Dungeon.ItemRestoreEvent, PMDC": {"disposition": "planned_item_dependent", "step": "7.4", "gate": ""},
	"PMDC.Dungeon.SwitchHeldItemEvent, PMDC": {"disposition": "planned_item_dependent", "step": "7.4", "gate": ""},
...
func _entry_for_move(move: PokemonMoveResource, unmapped_tags: Array[String]) -> Dictionary:
	...
	var no_effect: bool = effective_families.is_empty() and move.base_power <= 0 and not unsupported.is_empty()
	return {
